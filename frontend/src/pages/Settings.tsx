...
import { useHardwareDetection, useDetectHardware } from '../hooks/useQueries'
...
const Settings: React.FC = () => {
  ...
  return (
    <Box className="fade-in settings-page">
      ...
      {/* Looking for AI Models? They moved to the Models page in the left menu.
          TODO: remove this migration alert after one release cycle. */}
      <Alert
        severity="info"
        sx={{ mb: 2 }}
        action={
      ...
      >
        AI Models moved to the <strong>Models</strong> page in the left menu.
      </Alert>
